 ...
 int main()
 {
     ...
     GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Dois Triangulos -- Ender", nullptr, nullptr);
     if (!window)
     {
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         // item a) exercicio 6
         glUniform4f(colorLoc, 0.0f, 0.2f, 0.5f, 1.0f);
         glDrawArrays(GL_TRIANGLES, 0, 6);

         // item b) exercicio 6
         glUniform4f(colorLoc, 0.3f, 0.1f, 0.9f, 1.0f);
